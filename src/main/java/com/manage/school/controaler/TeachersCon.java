...
//
    ...
    @GetMapping("/Teachersshow/edit/{TID}")
    public String edit(@PathVariable("TID") long TID, Model m){

        Teachers teacher = teachersSer.getByTID(TID);
    ...
    public String UpdateTeacher(@ModelAttribute Teachers teachers, Model model, HttpSession session){
        ...
        session.setAttribute("msg","Teachers updated Sucessfully...");
        return "StudentAdd";
    }
}
